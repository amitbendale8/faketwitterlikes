...
import com.demo.linkedind.AuthHandler;
import com.google.gdata.data.codesearch.File;

public class LinkedInUtility {
	private static String API_KEY = "810avlfxv5xj41";
    private static String API_SECRET = "kDg8IJlNXFMpUfgU";

    public static void testLinkedIn() {
        ...
        try{
            ...
            if(file != null){
                ...
                ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream("service.dat"));
       ...
       url = "http://api.linkedin.com/v1/people-search:(people:(id))?first-name=bill&last-name=gates";
        request = new OAuthRequest(Verb.GET, url);
